...
define view entity ZBAS_I_Booking_M
  as select from zBAS_booking_m as Booking

  association        to parent ZBAS_I_Travel_M   as _Travel        on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZBAS_I_BookSuppl_M       as _BookSupplement
