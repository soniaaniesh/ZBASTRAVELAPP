...
define view entity ZRAM_I_Booking_M
  as select from zram_booking_m as Booking

  association        to parent ZRAM_I_Travel_M   as _Travel        on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZRAM_I_BookSuppl_M       as _BookSupplement
